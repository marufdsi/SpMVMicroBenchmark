...
\section{\todo{SpMV on AVX-512 Architecture (Skylake, Cascade Lake)}}
...
\begin{figure}[hbt!]
	...
	\subfigure[Vector Width: 8]{\includegraphics[width=0.48\linewidth]{figures/skylake_mpi_fma_roofline_model_for_vec_8.pdf}		\label{fig:mpi-skl-vec-4}}
