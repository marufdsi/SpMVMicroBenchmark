...
\begin{figure}[hbt!]
	\centering
	\subfigure[Single Precision.]{\includegraphics[width=0.96\linewidth]{figures/stream/skylake_mpi_copy_double_precision_time.pdf}		\label{fig:stream-single-copy}}
	%\subfigure[Double Precision.]{\includegraphics[width=0.48\linewidth]{figures/stream/skylake_mpi_copy_double_precision.pdf}		\label{fig:stream-double-copy}}
	\caption{double precision memory access time on Skylake processor.}
	\label{fig:stream-copy-bandwidth}
\end{figure}
